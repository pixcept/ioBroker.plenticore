...
// TODO: Strategy 2					
					adapter.log.info('#TODONN Checking battery management: power_plus < panelWp * maxFeedInFactor: ' + power_plus + ' < ' + panelWp + ' * ' + maxFeedInFactor + ' (enable_smart_battery_control was before: ' + enable_smart_battery_control);
