...
function parseMetnoData(json, callback) {
	...
	for(let i = 0; i < forecastArr.length; i++) {
		...
		if(entry.data.next_1_hour && entry.data.next_1_hour.details && 'precipitation_amount' in entry.data.next_1_hour.details) {
			fc_rain = parseFloat(entry.data.next_1_hour.details.precipitation_amount);
